...
def adminDashboard(request):
    ...
    msg = {
        ...
        'to_email': 'maunducyrus123@gmail.com',
...
def addStock(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            return redirect('add_stock')  # Redirect to the same page or another as needed
    else:
        form = StockForm()  # Initialize an empty form for GET requests
